...
@testset "Risk models" begin
    ...
    testcov = reshape([8.938293461392911e-5,
    ...
    testcov = reshape([0.00010101383661595715,
    ...
    @test S ≈ reshape([0.00020974121242454973,
                       9.49008624680715e-5,
    ...
    @test S ≈ reshape([9.01474993935186e-5,
