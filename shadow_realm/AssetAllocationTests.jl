...
@testset "Asset allocation" begin
    ...
    @test isapprox(portfolio.budget * 1e6, sum(w10.cost), rtol = 1e-5)
    @test isapprox(portfolio.budget * 1e6, sum(w11.cost), rtol = 1e-5)
    @test isapprox(portfolio.budget * 1e4, sum(w12.cost), rtol = 1e-3)
    @test isapprox(portfolio.budget * 1e4, sum(w13.cost), rtol = 1e-2)
    @test isapprox(portfolio.budget * 1e2, sum(w14.cost), rtol = 1e-1)
    @test isapprox(portfolio.budget * 1e2, sum(w15.cost), rtol = 1e-2)
    @test isapprox(portfolio.budget * 1e8, sum(w16.cost), rtol = 5e-7)
    @test isapprox(portfolio.budget * 1e8, sum(w17.cost), rtol = 5e-7)
