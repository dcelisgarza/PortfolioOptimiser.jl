...
@testset "Test adding skewness to another measure" begin
    ...
    w14t = [1.5365064547283644e-7, 0.02437633461456116, 1.299823053389551e-7,
...
@testset "$(:Classic), $(:Trad), $(:CVaR)" begin
    ...
    w6t = [3.366953452401694e-10, 0.0363592286656128, 3.407834235333678e-10,
           9.505734799431063e-10, 0.017177325642725713, 2.891094648518211e-10,
           1.1182379567078391e-10, 0.0916425860096116, 1.9796562590999384e-10,
           2.1579704965546995e-10, 0.3225839762265742, 1.6591968284748282e-10,
           9.740929244227103e-11, 0.039550817934523176, 2.853390379536195e-10,
           0.030919375378109692, 4.5593821234062755e-10, 0.37332985748934955,
           2.450246534871053e-10, 0.0884368289611142]
    ...
    w12t = [2.5378251882179444e-9, 2.7223579621430162e-9, 3.3724515165822403e-9,
            3.0377060536854278e-9, 0.8533951348998245, 1.1737201600772792e-9,
            0.14660482279881767, 1.8294127851764166e-9, 2.8988001864703366e-9,
            1.921672747181017e-9, 1.724454426500745e-9, 1.1165486087393359e-9,
            8.112138349039392e-10, 1.4351186585917892e-9, 8.185915282455332e-10,
            5.811187465397557e-9, 3.747002094239602e-9, 1.9431437591297996e-9,
            3.094948757293659e-9, 2.3052021806361524e-9]
...
@testset "$(:Classic), $(:Trad), $(:RVaR)" begin
    ...
    w3t = [2.87724425617166e-10, 0.2110466747628995, 2.9587513628834394e-10,
           1.969318459164221e-9, 9.584712566828088e-10, 5.364243295905063e-10,
           0.03667015651861076, 0.061045111022351446, 2.324417595449666e-10,
           2.529635741645663e-10, 0.49353473761033156, 1.3343581655792344e-10,
           2.920689347762896e-10, 2.4060322230405395e-10, 8.085555281094896e-10,
           7.550124238503323e-10, 1.7595541712472791e-9, 7.665884562442944e-10,
           3.036902709020037e-10, 0.1977033104930789]
    ...
    w7t = [1.0128114248135426e-8, 2.919284684393209e-8, 7.4274551935758925e-9,
           1.4711634944391727e-8, 0.5059934664095621, 2.479833382954539e-9,
           0.1723403428213986, 2.0971460463285154e-8, 1.2724494415336161e-8,
           3.8664665841063646e-8, 2.062633767748736e-6, 2.487164834892637e-9,
           1.6697303014953356e-9, 9.866135293518013e-9, 2.4468710718289533e-9,
           0.1824767817499871, 0.13918698511928995, 2.5785586474941442e-8,
           1.767698346242954e-7, 5.9401666629357126e-9]
    ...
    w9t = [1.371925060994481e-7, 5.017113355723874e-7, 1.0662532393517247e-7,
           2.0490149581065975e-7, 0.4815468090751088, 3.330618926216868e-8,
           0.15041200728999612, 3.4626438462291226e-7, 1.7162950949081867e-7,
           3.2384235095491527e-7, 0.022473217384017464, 3.232930432910352e-8,
           2.1497716252794512e-8, 1.1945719254114186e-7, 2.933687928446112e-8,
           0.17739861266035745, 0.16816211137726053, 3.6114503006980573e-7,
           4.765837248467376e-6, 8.71367928505167e-8]
...
@testset "$(:Classic), $(:Trad), $(:UCI)" begin
    ...
    w8t = [3.7143106165546923e-9, 8.800766845252557e-9, 0.19291377600494464,
           3.4270493331757744e-9, 0.23084901975084615, 1.3018817407243618e-9,
           2.5228708603450018e-8, 0.13727472799016124, 3.5563726179218376e-9,
           3.067268765562331e-9, 0.11254238622197182, 1.275285693905723e-9,
           8.646382666440933e-10, 4.678296278807188e-9, 9.464520106275406e-10,
           0.1537559906555194, 0.12948542269201874, 7.053459859151451e-9,
           0.0138305307910224, 0.029348081979024887]
...
@testset "$(:Classic), $(:Trad), $(:RDaR)" begin
    ...
    w7t = [1.62026825109458e-8, 1.1140659835581946e-8, 0.042698223156915835,
           4.540056898490461e-9, 0.27528471421890166, 2.5886366524288364e-9,
           4.359943546608122e-9, 0.09149825123122789, 3.614979738186598e-9,
           4.1490141377197875e-9, 0.3004550569094401, 2.158908689003697e-9,
           1.3867702010219014e-9, 6.228104903190852e-9, 2.0225083226948587e-9,
           0.29006363975665367, 1.8040707990697115e-8, 9.883955845368911e-9,
           8.02961390051683e-9, 2.0380317737852445e-8]
...
@testset "$(:Classic), $(:Trad), Reduced $(:Kurt)" begin
    ...
    @test isapprox(w4.weights, w4t)
    @test isapprox(w5.weights, w5t)
    @test isapprox(w7.weights, w7t, rtol = 5.0e-7)
    @test isapprox(w10.weights, w10t)
    @test isapprox(w11.weights, w11t)
...
@testset "$(:Classic), $(:Trad), Full $(:SKurt)" begin
    ...
    w7t = [8.262634412783149e-8, 3.429055223611667e-5, 8.552744506874907e-8,
           1.0516834271413609e-7, 0.32096393247711036, 1.9846044196184827e-8,
           0.004686373463481955, 0.052736635300551164, 6.750626896947074e-8,
           5.166245406625996e-8, 0.24476417910186632, 1.79554291656356e-8,
           9.389541370235793e-9, 5.4612179094380514e-8, 1.0607210709852576e-8,
           0.1358540213270602, 0.24095692829076537, 1.9015711064548837e-6,
           2.559740026379518e-7, 9.770405600616755e-7]
...
@testset "$(:Classic), $(:Trad), Reduced $(:SKurt)" begin
    ...
    w7t = [9.314737762842888e-8, 1.8967448813980331e-6, 9.169510138324964e-8,
