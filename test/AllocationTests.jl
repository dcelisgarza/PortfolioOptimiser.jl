...
@testset "Allocation" begin
    ...
    portfolio = Portfolio2(; prices = prices, solvers = solvers,
                           alloc_solvers = alloc_solvers)
    asset_statistics2!(portfolio)
    w0 = optimise2!(portfolio)

    w1 = allocate2!(portfolio; method = LP2())
    w2 = allocate2!(portfolio; method = Greedy2())
    w3 = allocate2!(portfolio; method = LP2(), investment = 1e4)
    w4 = allocate2!(portfolio; method = Greedy2(), investment = 1e4)
    w5 = allocate2!(portfolio; method = LP2(), investment = 1e2)
    w6 = allocate2!(portfolio; method = Greedy2(), investment = 1e2)
    w7 = allocate2!(portfolio; method = LP2(), investment = 1e8)
    w8 = allocate2!(portfolio; method = Greedy2(), investment = 1e8)

    portfolio.short = true
    w9 = optimise2!(portfolio)
    w10 = allocate2!(portfolio; method = LP2())
    w11 = allocate2!(portfolio; method = Greedy2())
    w12 = allocate2!(portfolio; method = LP2(), investment = 1e4)
    w13 = allocate2!(portfolio; method = Greedy2(), investment = 1e4)
    w14 = allocate2!(portfolio; method = LP2(), investment = 1e2)
    w15 = allocate2!(portfolio; method = Greedy2(), investment = 1e2)
    w16 = allocate2!(portfolio; method = LP2(), investment = 1e8)
    w17 = allocate2!(portfolio; method = Greedy2(), investment = 1e8)
    w18 = allocate2!(portfolio; method = LP2(), investment = 1e6, reinvest = true)
    w19 = allocate2!(portfolio; method = Greedy2(), investment = 1e6, reinvest = true)
