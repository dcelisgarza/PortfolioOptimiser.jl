...
@testset "EVaR" begin
    ...
    w11 = optimise!(portfolio, Trad(; rm = rm, kelly = AKelly(), obj = obj))
    wt = [4.56107043192365e-9, 5.8487627513665045e-9, 8.903741364006657e-9,
          7.383578077753038e-9, 0.8503222075484893, 1.591301516435967e-9,
          0.14967770045582557, 1.7578268111746564e-9, 6.855397828742627e-9,
          2.5161399084724168e-9, 1.3906038522225865e-9, 1.4823806434457172e-9,
          3.1787383818491866e-9, 1.9462865974317803e-10, 2.9839032709677685e-9,
          1.828414646226647e-8, 1.0682258084215633e-8, 2.225117382782486e-9,
          7.769542862639624e-9, 4.386546740871983e-9]
    @test isapprox(w11.weights, wt)
...
@testset "RLVaR" begin
    ...
    w11 = optimise!(portfolio, Trad(; rm = rm, kelly = AKelly(), obj = obj))
    wt = [4.555576238086713e-9, 5.847592270875289e-9, 8.911239345347116e-9,
          7.3865516448640335e-9, 0.8503221379967081, 1.5964232245735013e-9,
          0.14967776993026422, 1.7495737147613388e-9, 6.853217775907391e-9,
          2.5056878481958215e-9, 1.3853255756545406e-9, 1.4893039677013103e-9,
          3.225767405831666e-9, 2.0445814599560556e-10, 2.9692295644790794e-9,
          1.8321574378025388e-8, 1.0696053257987574e-8, 2.219668468277309e-9,
          7.772681913974766e-9, 4.3831028858775834e-9]
    @test isapprox(w11.weights, wt)
    ...
    optimise!(portfolio, Trad(; rm = rm, obj = obj))
    @test calc_risk(portfolio, :Trad; rm = rm) <= r2 ||
          abs(calc_risk(portfolio, :Trad; rm = rm) - r2) < 1e-5
...
@testset "UCI" begin
    ...
    w11 = optimise!(portfolio, Trad(; rm = rm, kelly = AKelly(), obj = obj))
    wt = [1.718208996605602e-9, 1.6743844181913202e-9, 1.5780356576205686e-9,
          1.6248012097351933e-9, 0.8503200846197925, 1.9129887782959393e-9,
          0.14967988430251294, 1.7985589293678039e-9, 1.637276808533285e-9,
          1.7767063327120719e-9, 1.8100369182445875e-9, 1.906980145397638e-9,
          1.9519620546273887e-9, 1.862411093914473e-9, 1.954050214049456e-9,
          1.2463028732299733e-9, 1.5157124110454867e-9, 1.7858120767349577e-9,
          1.6049515790981468e-9, 1.7185140396032024e-9]
    @test isapprox(w11.weights, wt)
