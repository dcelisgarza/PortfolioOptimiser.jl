...
@testset "Portfolio RB classes" begin
    ...
    frct = [0.00014089041888460887, 0.00014088908650724418, 0.00014088839561754608,
            -1.1969818799595846e-14]
    ...
    frct = [6.56958259070456e-5, 0.0001313937244307043, 0.0001970860034074569,
            -2.664278562555018e-14]
    ...
    wt = [0.08170925623690223, 0.10455256562057738, 0.12404101030136445,
          ...
          0.1444148138830274]
    frct = [0.00010411477756793318, 0.00010410977794685727, 0.00010410989364595898,
            -1.982198134575252e-20]
    ...
    wt = [0.1290819501060403, 0.09077164796746803, 0.1620757594996783, 0.1688745651621904,
          ...
          0.1663588773147133]
    frct = [5.034839040684537e-5, 0.00010069522858101765, 0.0001510332795580634,
            -1.348660504087133e-20]
    ...
    wt = [-2.3015557979838155, 1.015632612233884, 1.4947894574786151, -0.5829581771148582,
          ...
          -0.2952792208011381]
    frct = [0.000878325080160221, 0.000878293790546871, 0.0008782899901669645,
            0.0008781573327196996, 0.000878284070774536, -1.3766350632688036e-13]
    ...
    frct = [0.00023635754535142952, 0.00047269298995944583, 0.0007090180801724034,
            0.0009451751894404064, 0.0011815735538377417, -3.6334661810153253e-13]
    ...
    frct = [0.00115013535097452, 0.0011502575315581146, 0.0011502318848496018,
            0.0011501611304466691, 0.0011501410715576616, -2.4024927678116797e-19]
    ...
    frct = [0.0001053936063078848, 0.00021078438817998985, 0.00031616728835474195,
            0.0004214695857120913, 0.0005268688766260096, -2.9193714915918085e-20]
    @test isapprox(w8.weights, wt, rtol = 1.0e-4)
