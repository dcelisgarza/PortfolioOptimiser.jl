...
@testset "Plotting" begin
    ...
    @test plt2.n == 1
    plt3 = plot_bar(portfolio; type = :RP)
    @test plt3.n == 1
    plt4 = plot_risk_contribution(portfolio; type = :RP, rm = rm, percentage = true)
    @test plt4.n == 2
    ...
    @test plt7.n == 21
    plt8 = plot_drawdown(portfolio; type = :RP)
    @test plt8.n == 9
    plt9 = plot_hist(portfolio; type = :RP)
    @test plt9.n == 12
    ...
    @test ptl21.n == 75
    ptl22 = plot_network(portfolio; type = :RP, cluster = false, network_type = TMFG())
    @test ptl22.n == 75
end
