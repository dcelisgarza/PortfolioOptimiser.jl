...
@testset "msv" begin
    ...
    @test isapprox(w4t, w4[!, :weights], rtol = 5e-8)
end
...
@testset "wr" begin
    ...
    @test isapprox(w4t, w4[!, :weights], rtol = 2e-7)
end
...
@testset "evar" begin
    ...
    @test isapprox(w3t, w3[!, :weights], rtol = 1e-9)
    @test isapprox(w4t, w4[!, :weights], rtol = 9e-7)
end
...
@testset "rdar" begin
    ...
    @test isapprox(w2t, w2[!, :weights], rtol = 1e-5)
