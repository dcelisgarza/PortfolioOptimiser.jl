...
@testset "Weight bounds" begin
    ...
    w1_1 = optimise!(portfolio, HRP(; rm = CDaR(), finaliser = JWF(; version = RNF())))
    ...
    w1_2 = optimise!(portfolio, HRP(; rm = CDaR(), finaliser = JWF(; version = RSF())))
    ...
    w1_3 = optimise!(portfolio, HRP(; rm = CDaR(), finaliser = JWF(; version = ANF())))
    ...
    w1_4 = optimise!(portfolio, HRP(; rm = CDaR(), finaliser = JWF(; version = ASF())))
    wt = [0.057364912846114065, 0.048752191394273905, 0.05564151063694583,
          0.03278388203530661, 0.0700000009978663, 0.04180146612390559, 0.03328620020944123,
          0.05173717215728229, 0.04182990540805701, 0.05336997481187418,
          0.04000000116060582, 0.021884926824836937, 0.021860455167492077,
    ...
    w13_2 = optimise!(portfolio,
                      NCO(; internal = NCOArgs(; type = Trad(; rm = CDaR())),
                          finaliser = JWF(; version = RSF())))
    wt = [0.13676672834665476, -0.01814231488243482, 0.1500000036591071,
          -0.015969197835835357, -0.016628649040868963, 0.046404228032618455,
          -0.013157294799361617, 0.03397888675936728, -0.01836163331109271,
          0.0126635627892295, 0.15000000794965046, -0.012630573302295917,
          0.004638357658430231, -0.020094513835537092, -0.0008150335198798222,
          -0.01865259283179267, 0.15000000860002008, 0.1500000031931629,
          0.15000000790484747, 0.15000000846601047]
