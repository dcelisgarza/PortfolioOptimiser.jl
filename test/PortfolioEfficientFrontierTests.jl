...
@testset "$(:Classic), $(:Trad), $(:SD)" begin
    ...
    w1 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :SD,
                   obj = :Min_Risk,
                   kelly = :None,)
    w2 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :SD,
                   obj = :Max_Ret,
                   kelly = :None,)
    w3 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :SD,
                   obj = :Sharpe,
                   kelly = :None,)
    fw1 = efficient_frontier!(portfolio; class = :Classic, hist = 1,
                              kelly = :None, rf = rf,
                              rm = :SD, points = 5,)

    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :SD, rf = rf,
                        sigma = sigma,
...
@testset "$(:Classic), $(:Trad), $(:MAD)" begin
    ...
    w1 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :MAD,
                   obj = :Min_Risk,
                   kelly = :None,)
    w2 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :MAD, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:SSD)" begin
    ...
    w1 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :SSD,
                   obj = :Min_Risk,
                   kelly = :None,)
    w2 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :SSD, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:FLPM)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :FLPM, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:SLPM)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :SLPM, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:WR)" begin
    ...
    w1 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :WR,
                   obj = :Min_Risk,
                   kelly = :None,)
    w2 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :WR, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:CVaR)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :CVaR, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:EVaR)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :EVaR, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:RVaR)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :RVaR, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:MDD)" begin
    ...
    w1 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :MDD,
                   obj = :Min_Risk,
                   kelly = :None,)
    w2 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :MDD, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:ADD)" begin
    ...
    w1 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :ADD,
                   obj = :Min_Risk,
                   kelly = :None,)
    w2 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :ADD, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:CDaR)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :CDaR, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:UCI)" begin
    ...
    w1 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :UCI,
                   obj = :Min_Risk,
                   kelly = :None,)
    w2 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :UCI, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:EDaR)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :EDaR, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), $(:RDaR)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :RDaR, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), Full $(:Kurt)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :Kurt, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "$(:Classic), $(:Trad), Full $(:SKurt)" begin
    ...
    risks1 = [calc_risk(fw1[:weights][!, i], returns; rm = :SKurt, rf = rf,
                        sigma = sigma,
                        alpha_i = alpha_i, alpha = alpha, a_sim = a_sim,
                        beta_i = beta_i,
                        beta = beta, b_sim = b_sim, kappa = kappa,
...
@testset "Efficient frontier, all kelly returns" begin
    ...
    fw1 = efficient_frontier!(portfolio; class = :Classic, hist = 1,
                              kelly = :None, rf = rf,
                              rm = :SKurt, points = 25,)
    risks1 = [calc_risk(fw1[:weights][!, i], portfolio.returns; rm = :SKurt,
                        rf = rf,
                        solvers = portfolio.solvers,)
              for i in 2:size(Matrix(fw1[:weights]), 2)]
    rets1 = [dot(fw1[:weights][!, i], portfolio.mu)
    ...
    rets1[(idx + 1):end] = rets1[idx:(end - 1)]
    rets1[idx] = tmp
    w4 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :SKurt,
                   obj = :Min_Risk, kelly = :Approx,)
    w5 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :SKurt,
                   obj = :Max_Ret, kelly = :Approx,)
    w6 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :SKurt,
                   obj = :Sharpe,
                   kelly = :Approx,)
    fw2 = efficient_frontier!(portfolio; class = :Classic, hist = 1,
                              kelly = :Approx,
                              rf = rf, rm = :SKurt, points = 25,)
    risks2 = [calc_risk(fw2[:weights][!, i], portfolio.returns; rm = :SKurt,
                        rf = rf,
                        solvers = portfolio.solvers,)
    ...
    rets2[idx] = tmp
    w7 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :CDaR,
                   obj = :Min_Risk, kelly = :Exact,)
    w8 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :CDaR,
                   obj = :Max_Ret,
                   kelly = :Exact,)
    w9 = opt_port!(portfolio; rf = rf, l = l, class = :Classic, hist = 1,
                   type = :Trad,
                   rrp_ver = :None, u_mu = :None, u_cov = :None, rm = :CDaR,
                   obj = :Sharpe,
                   kelly = :Exact,)
    fw3 = efficient_frontier!(portfolio; class = :Classic, hist = 1,
                              kelly = :Exact,
                              rf = rf, rm = :CDaR, points = 25,)
    risks3 = [calc_risk(fw3[:weights][!, i], portfolio.returns; rm = :CDaR,
                        rf = rf,
                        solvers = portfolio.solvers,)
