...
@testset "Weight bounds" begin
    ...
    constraints = DataFrame(; Enabled = fill(true, 20),
                            Type = fill("Assets", 20),
                            Position = ["GOOG",
                                        "AAPL",
                                        "FB",
