...
wt = [0.05620454939911102, 3.025963157432751e-10, 1.55525199050249e-9,
      ...
      0.14345074805893418, 0.15965735285676014, 0.06193188215818479, 7.588611460321727e-10,
      0.0648851604178394]
...
w8 = optimise2!(portfolio; rm = rm, kelly = AKelly(), obj = obj)
wt = [1.3941605837370376e-8, 1.7379340419048453e-8, 0.09397022998439407,
      4.750316566009424e-9, 0.26905912766854545, 2.542244985356096e-9, 4.91745934990303e-9,
      0.08496764823992713, 4.463542154906836e-9, 4.642417547118547e-9, 0.3074751732915163,
      2.3694756580977916e-9, 1.4891401987349052e-9, 7.457741148473212e-9,
      2.075810974315586e-9, 0.24452732721152728, 9.005394657577373e-8,
      1.4263955038493934e-8, 1.2495404239355042e-8, 3.107616890388338e-7]
@test isapprox(w8.weights, wt, rtol = 5e-6)
...
w11 = optimise2!(portfolio; rm = rm, kelly = AKelly(), obj = obj)
wt = [6.068095174605424e-11, 5.7846613951361576e-11, 5.0197530596015976e-11,
      5.3741710729620396e-11, 0.850324458152055, 7.296755090668262e-11, 0.14967554075126555,
      6.721896865257403e-11, 5.559668815809807e-11, 6.580954912658916e-11,
      6.808602673456642e-11, 7.36574868892983e-11, 7.687598262811075e-11,
      7.133408967580721e-11, 7.657784586791197e-11, 2.174156234690718e-11,
      4.434054545875643e-11, 6.617876171264754e-11, 5.2687777046890895e-11,
      6.113986905642583e-11]
@test isapprox(w11.weights, wt)
