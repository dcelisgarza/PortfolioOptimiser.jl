...
@testset "Asset statistics" begin
    ...
    covg0t = reshape([0.00020997582228184753,
    ...
    asset_statistics!(portfolio;
                      mu_weights = eweights(size(portfolio.returns, 1), eps();
                                            scale = true))
    ...
    covgt2 = reshape([0.00020974121242454936,
                      8.70065424759032e-5,
    ...
    covjt = reshape([0.00020997582228184737,
    ...
    cov_mtx = reshape([3.21391539839344,
                       1.3953377554695519,
                       2.5674375637791624,
                       2.4443650120801395,
                       3.0704634820747216,
    ...
    cov1t = reshape([3.213915398393439,
                    ...
                    7,
                    7)
    cov2t = reshape([3.21391539839344,
                     2.0152814765540374,
                     2.9215733547540728,
                     2.7424052490583763,
                     3.428314111194968,
                    ...
                    7,
                    7)
    cov3t = reshape([3.2139153983934414,
                     1.579713913957069,
                     2.517604322789144,
                     2.3089729560851726,
                     3.059341699088417,
                    ...
                    7,
                    7)
    cov4t = reshape([3.2139153983934414,
                     1.4875258347133102,
                     2.542520943284153,
                     2.376668984082656,
                     3.0649025905815686,
                    ...
                    7,
                    7)
    cov5t = reshape([3.2139153983934414,
                     1.3953377554695514,
                     2.5674375637791624,
                     2.444365012080139,
                     3.0704634820747208,
                    ...
                    7,
                    7)
    cov6t = reshape([0.24337744933743052,
                     0.23059488563424985,
                     -0.29798568333686415,
                     -0.256426340850148,
                     -0.3010501028932296,
                    ...
                    7,
                    7)
    cov7t = reshape([0.24337744933743125,
                     0.6549798090041442,
                     0.2701695993290464,
                     0.28719739243072273,
                     0.3470281654776778,
                    ...
                    7,
                    7)
    cov8t = reshape([0.24337744933743266,
                     0.21941224640717577,
                     -0.13379943263588245,
                     -0.14623490054248112,
                    ...
                    7,
                    7)
    cov9t = reshape([0.24337744933743266,
                     0.12722416716341695,
                     -0.10888281214087346,
                     -0.07853887254499792,
                    ...
                    7,
                    7)
    cov10t = reshape([0.24337744933743266,
                      0.03503608791965811,
                      -0.08396619164586414,
    ...
    portfolio = HCPortfolio(; returns = returns)
    asset_statistics!(portfolio; cor_method = :Cov_to_Cor)
    @test isapprox(cov2cor(portfolio.cov), portfolio.cor)
    function func(x)
        return sqrt.(clamp!((1 .- x) / 2, 0, 1))
    end
    asset_statistics!(portfolio; cor_method = :Custom_Func, dist_func = func)
...
@testset "Loadings matrix" begin
    ...
    lmtx1t = reshape([-0.30994820979398263,
    ...
    lmtx2t = reshape([-0.30994820979398263,
                      -0.012770302754892965,
                      0.15087582050756498,
                      -0.5931508872820731,
                      -0.4059835747542855,
    ...
    lmtx3t = reshape([-0.41718611743313244,
    ...
    lmtx4t = reshape([-0.4077068203609503,
    ...
    sigma1t = reshape([1.1786107704560354,
                       -0.09042955086258173,
                       0.11271105599498585,
                      ...
                      11,
                      11)
    sigma2t = reshape([0.13689465592250286,
                       -0.09042955086258173,
                       0.11271105599498585,
                       -0.013168640001057955,
                       0.11906725683036683,
    ...
    returns1t = reshape([-0.2089823534526834,
                         -0.6107542452232544,
                         -0.8904335938236764,
                         -0.2698540075177232,
                         -0.5009828415888199,
                        ...
                        23,
                        11)
    returns2t = reshape([-0.2089823534526834,
                         -0.6107542452232544,
                         -0.8904335938236764,
                         -0.2698540075177232,
                         -0.5009828415888199,
...
@testset "Black litterman" begin
    ...
    wbt = [0.04994419642839887,
           ...
           -36.435053423915775,
           -23.228945589531968]
    cov_mtxt = reshape([0.00021019372803673762,
    ...
    views = DataFrame(Dict("Enabled" => [true, true, true],
    ...
    cov_mtxabt1 = reshape([2.1533865165434455e-6,
                           3.28910821006002e-6,
    ...
    cov_mtxabt2 = reshape([1.974978406015164e-5,
    ...
    mub1, sigma_b1, wb1 = bayesian_black_litterman(port.returns,
                                                   port.f_returns,
    ...
    covbt1 = reshape([1.8492511130154584e-5,
    ...
    mub2, sigma_b2, wb2 = bayesian_black_litterman(port.returns,
                                                   port.f_returns,
                                                   Matrix(loadings[!, 2:end]),
                                                   P_f,
                                                   Q_f / 252; constant = false,
    ...
    covbt2 = reshape([2.174018477350132e-6,
    ...
    cov_fmt = reshape([1.9733861670583968e-5,
    ...
    cov_fmt = reshape([1.9729635884430235e-5,
    ...
    @test isapprox(port.bl_bench_weights,
    ...
    mub1, covb1, wb1 = bayesian_black_litterman(port.returns,
                                                port.f_returns,
                                                Matrix(loadings[!, 2:end]),
                                                P_f,
                                                Q_f / 252; constant = false)
    ...
    f_views = DataFrame(Dict("Enabled" => [true, true, true],
                             "Factor" => ["R 10800", "R 1800", "R 3600"],
                             "Sign" => [">=", "<=", "<="],
                             "Value" => [0.001, -0.001, -0.003],
                             "Relative Factor" => ["R 7200", "", ""]))
    ...
    mub2, covb2, wb2 = bayesian_black_litterman(port.returns,
                                                port.f_returns,
                                                Matrix(B[!, 2:end]),
                                                P_f1,
    ...
    try
        black_litterman_factor_satistics!(port;                                          # w;                                          # Black Litterman
                                          ...
                                          # criterion = :pval,
                                          diagonal = false,)
        mub3, covb3, wb3 = bayesian_black_litterman(port.returns,
                                                    port.f_returns,
                                                    Matrix(B[!, 2:end]),
                                                    P_f1,
                                                    Q_f1 / 252; constant = true,
    ...
    mub4, covb4, w4 = augmented_black_litterman(port.returns,
                                                fill(1 / length(port.assets),
                                                     length(port.assets));
                                                F = port.f_returns,
    ...
    mub5, covb5, wb5 = augmented_black_litterman(port.returns,
                                                 fill(1 / length(port.assets),
                                                      length(port.assets));
                                                 F = port.f_returns,
                                                 B = Matrix(B[!, 2:end]),
    ...
    mub6, covb6, w6 = augmented_black_litterman(port.returns,
                                                fill(1 / length(port.assets),
                                                     length(port.assets));
                                                F = port.f_returns,
                                                B = Matrix(loadings[!, 2:end]),
    ...
    mub7, covb7, w7 = augmented_black_litterman(port.returns,
                                                fill(1 / length(port.assets),
                                                     length(port.assets));
                                                F = port.f_returns,
                                                B = Matrix(loadings[!, 2:end]),
