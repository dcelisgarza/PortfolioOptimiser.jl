...
@testset "$(:Classic), $(:RP), $(:SSkew)" begin
    ...
    w1t = [0.047627480727706284, 0.05277910193358604, 0.04313963666075417,
           0.04073191785001159, 0.0465469563705933, 0.0513285358730995,
           0.028822930007516498, 0.0795636573796064, 0.037614233088814,
           0.043809278398601874, 0.08400588117516951, 0.03702647503496133,
           0.0333555677494848, 0.06020054350131297, 0.040430034070265665,
           0.050438992699136556, 0.04930313431757592, 0.07086660151322399,
           0.043803267077769006, 0.0586057745708107]
...
@testset "$(:Classic), $(:RP), $(:MAD)" begin
    ...
    w2t = [0.006399565706591152, 0.012599537563306997, 0.017344100326461352,
           0.01913716135852341, 0.02837647389603422, 0.031901374290753445,
           0.01920708992556608, 0.05539148225169867, 0.03338308837756121,
           0.045148037598083744, 0.08075951606838366, 0.03494226700307825,
           0.025785186259787915, 0.07994552010930656, 0.044756122498037475,
           0.05591472407289863, 0.0922777858952933, 0.12028025352139986,
           0.08191446689723242, 0.11453624638000168]
...
@testset "$(:Classic), $(:RP), $(:FLPM)" begin
    ...
    w2t = [0.0068825848124165565, 0.012960393169105909, 0.01838954744965383,
           0.018318311467547047, 0.036076300569312124, 0.02719944537911736,
           0.02021313316056618, 0.052780054519165565, 0.03376358597757392,
           0.04423885831550566, 0.08233687369255722, 0.03175527782127306,
           0.024158200095757757, 0.07390330552762367, 0.03807083803312209,
           0.05746037766121883, 0.09954092061484353, 0.12219646799698154,
           0.08481960599370185, 0.11493591774295626]
...
@testset "$(:Classic), $(:RP), Full $(:Kurt)" begin
    ...
    w2t = [0.004745079290573024, 0.010553760217657363, 0.014134813791749226,
           0.021525375310442414, 0.022377406331696777, 0.03218313758293227,
           0.02458523891414795, 0.0603363956871766, 0.03328244329687931,
           0.04649936469297119, 0.08453399767572647, 0.04493874777318966,
           0.04021395117270975, 0.0735148528705856, 0.050478180609676744,
           0.06588289361928176, 0.07959690966033485, 0.10844014654607509,
           0.07731005027057396, 0.10486725468561997]
...
@testset "$(:Classic), $(:RP), Full $(:SKurt)" begin
    ...
    w2t = [0.004727801269301323, 0.011003985527497248, 0.013098557002924774,
           0.01776702128363724, 0.02118937369439015, 0.03181888265105485,
           0.020992303112960044, 0.05555443820565017, 0.03256365567086945,
           0.042363943322734736, 0.08220554986922095, 0.04516553157674425,
           0.04357123130779893, 0.07526210355877767, 0.05365470044129572,
           0.07061622974870017, 0.08204433863918342, 0.10761135978886063,
           0.07792590841865739, 0.11086308490974096]
...
@testset "$(:Classic), $(:RP), Reduced $(:SKurt)" begin
    ...
    w2t = [0.004723136621649846, 0.010993719138392958, 0.013080329326985229,
           0.017759686693039633, 0.021165529259188264, 0.03180327724962525,
           0.020974587176703516, 0.05554781464354644, 0.03254435653619886,
           0.04234283054782876, 0.08231341989599684, 0.04515381805720134,
           0.04355327752059459, 0.07523328326070142, 0.053657603235055265,
           0.07059733741996484, 0.08205669720197914, 0.1076705478718807,
           0.07790715723721939, 0.11092159110624765]
