...
"""
abstract type AbstractPortfolio2 end
...
Some of these require external information from the arguments of functions that use the an instance of [`Portfolio2`](@ref):
...
mutable struct Portfolio2{ast, dat, r, s, us, ul, nal, nau, naus, tfa, tfdat, tretf, l, lo,
                          ...
                          #   usk, ugmd, utg, urtg, uowa, udvar, uskew, usskew, owap, wowa
                          #####
...
"""
```
Portfolio2(; prices::TimeArray                                 = TimeArray(TimeType[], []),
...
Performs data validation and creates an instance of [`Portfolio2`](@ref). Union datatypes remain union datatypes in the instance.
...
# Outputs
  ...
  - [`Portfolio2`](@ref) instance.
"""
function Portfolio2(; prices::TimeArray = TimeArray(TimeType[], []),
                    returns::DataFrame = DataFrame(),
                    ret::AbstractMatrix{<:Real} = Matrix{Float64}(undef, 0, 0),
                    timestamps::AbstractVector = Vector{Date}(undef, 0),
    ...
    return Portfolio2{typeof(assets), typeof(timestamps), typeof(returns), typeof(short),
                      ...
                      TrackingErr, typeof(tracking_err), typeof(tracking_err_returns),
                      ...
                      #   typeof(skew_u), typeof(sskew_u),typeof(owa_p),typeof(owa_w),
                      #######
                      ...
                      typeof(alloc_model)}(assets, timestamps, returns, short, short_u,
                                           ...
                                           turnover_weights, kind_tracking_err,
...
function Base.deepcopy(obj::Portfolio2)
    return Portfolio2{typeof(obj.assets), typeof(obj.timestamps), typeof(obj.returns),
                      ...
                      #   typeof(obj.skew_u), typeof(obj.sskew_u),typeof(obj.owa_p), typeof(obj.owa_w),
                      ######
...
Some of these require external information from the arguments of functions that use the an instance of [`HCPortfolio2`](@ref):
...
"""
```
HCPortfolio2(; prices::TimeArray = TimeArray(TimeType[], []),
            returns::DataFrame = DataFrame(),
...
Performs data validation and creates an instance of [`HCPortfolio2`](@ref). Union datatypes remain union datatypes in the instance.
...
# Outputs
  ...
  - [`HCPortfolio2`](@ref) instance.
"""
function HCPortfolio2(; prices::TimeArray = TimeArray(TimeType[], []),
                      returns::DataFrame = DataFrame(),
                      ret::Matrix{<:Real} = Matrix{Float64}(undef, 0, 0),
                      timestamps::Vector{<:Dates.AbstractTime} = Vector{Date}(undef, 0),
                      assets::AbstractVector = Vector{String}(undef, 0),
...
export Portfolio2, HCPortfolio2, NoKelly, AKelly, EKelly, MinRisk, Util, SR, MaxRet, Trad2,
       RP2, NoRRP, RegRRP, RegPenRRP, RRP2, WC2, QuadSD, SOCSD, SimpleSD
