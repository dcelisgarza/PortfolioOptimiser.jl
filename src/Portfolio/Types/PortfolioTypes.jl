...
mutable struct Portfolio{ast, dat, r, tfa, tfdat, tretf, l, lo, s, sb, us, ul, nal, nau,
                         naus, mnak, mnaks, rb, to, kte, blbw, ami, bvi, rbv, frbv, nm, amc,
                         bvc, ler, tmu, tcov, tkurt, tskurt, tl2, ts2, tskew, tv, tsskew,
                         tsv, tmuf, tcovf, trfm, tmufm, tcovfm, tmubl, tcovbl, tmublf,
                         tcovblf, tcovl, tcovu, tcovmu, tcovs, tdmu, tkmu, tks, topt, tlim,
...
function HCPortfolio(; prices::TimeArray = TimeArray(TimeType[], []),
    ...
    return HCPortfolio{typeof(assets), typeof(timestamps), typeof(returns), typeof(mu),
                       ...
                       typeof(alloc_model)}(assets, timestamps, returns, mu, cov, kurt,
                                            skurt, L_2, S_2, skew, V, sskew, SV, w_min,
                                            w_max, cor, dist, clusters, k, optimal, solvers,
