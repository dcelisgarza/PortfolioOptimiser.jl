"""
```
_clusterise(ca::HAC, port::Union{HCPortfolio, OmniPortfolio}, clust_opt::ClustOpt = ClustOpt())
```
...
"""
function _clusterise(ca::HAC, port::OmniPortfolio, clust_opt::ClustOpt = ClustOpt())
...
"""
```
_clusterise(ca::DBHT, port::Union{HCPortfolio, OmniPortfolio}, clust_opt::ClustOpt = ClustOpt())
```
...
# Outputs
  ...
  - `k`: optimum number of clusters.
"""
function _clusterise(ca::DBHT, port::OmniPortfolio, clust_opt::ClustOpt = ClustOpt())
    S = port.cor
    D = port.dist
...
"""
```
cluster_assets(port::Union{HCPortfolio, OmniPortfolio}; clust_alg::ClustAlg = HAC(),
...
# Outputs
  ...
  - `k`: optimum number of clusters.
"""
function cluster_assets(port::OmniPortfolio; clust_alg::ClustAlg = HAC(),
                        clust_opt::ClustOpt = ClustOpt())
