...
function Portfolio(; prices::TimeArray = TimeArray(TimeType[], []),
    ...
    return Portfolio{typeof(assets), typeof(timestamps), typeof(returns), typeof(short),
                     ...
                     typeof(alloc_model)}(assets, timestamps, returns, short, short_u,
                                          ...
                                          k_mu, k_sigma, optimal, z, limits, frontier,
                                          solvers, fail, model, latest_prices,
                                          alloc_optimal, alloc_leftover, alloc_solvers,
...
function HCPortfolio(; prices::TimeArray = TimeArray(TimeType[], []),
    ...
    return HCPortfolio{typeof(assets), typeof(timestamps), typeof(returns), typeof(mu),
                       ...
                       typeof(alloc_model)}(assets, timestamps, returns, mu, cov, kurt,
                                            ...
                                            w_max, cor_type, cor, dist, clusters, k,
                                            optimal, solvers, fail, latest_prices,
                                            alloc_optimal, alloc_leftover, alloc_solvers,
                                            alloc_fail, alloc_model)
end
