...
function pre_modify_intra_port!(::NoNCOModify, intra_port, internal_args, i, k, cluster,
                                cidx, idx_sq, Nc, special_rm_idx)
    return nothing
end
function post_modify_intra_port!(::NoNCOModify, intra_port, internal_args, i, k, cluster,
                                 cidx, idx_sq, Nc, special_rm_idx)
    return nothing
end
function get_cluster_portfolio(port, internal_args, i, k, cluster, cidx, idx_sq, Nc,
                               special_rm_idx)
    ...
    pre_modify_intra_port!(pre_modify, intra_port, internal_args, i, k, cluster, cidx,
    ...
    post_modify_intra_port!(post_modify, intra_port, internal_args, i, k, cluster, cidx,
                            idx_sq, Nc, special_rm_idx)
...
function calc_intra_weights(port::Portfolio, internal_args)
    ...
    for i ∈ 1:k
        ...
        cw, cfail = get_cluster_portfolio(port, internal_args, i, k, cluster, cidx, idx_sq,
                                          Nc, special_rm_idx)
