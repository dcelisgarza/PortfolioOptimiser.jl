...
for (op, name) ∈
    zip((SD, Variance, MAD, SSD, SVariance, FLPM, SLPM, WR, VaR, CVaR, EVaR, RLVaR, DaR,
         ...
         RLDaR_r, Kurt, SKurt, GMD, RG, CVaRRG, TG, TGRG, OWA, BDVariance, NQSkew, NQSSkew,
         NSkew, NSSkew, Equal, WCVariance, TCM, TLPM, FTCM, FTLPM, Skewness, SSkewness,
         Kurtosis, SKurtosis, SchurParams, DRCVaR, NCOArgs, TrackingRM, TurnoverRM,
         PortOptSolver),
        ("SD", "Variance", "MAD", "SSD", "SVariance", "FLPM", "SLPM", "WR", "VaR", "CVaR",
         ...
         "RG", "CVaRRG", "TG", "TGRG", "OWA", "BDVariance", "NQSkew", "NQSSkew", "NSkew",
         "NSSkew", "Equal", "WCVariance", "TCM", "TLPM", "FTCM", "FTLPM", "Skewness",
         "SSkewness", "Kurtosis", "SKurtosis", "SchurParams", "DRCVaR", "NCOArgs",
         "TrackingRM", "TurnoverRM", "PortOptSolver"))
    eval(quote
