...
# Asset Statistics
       ...
       PortfolioOptimiser.BootstrapMethods,
       PortfolioOptimiser.MuMethods,
       PortfolioOptimiser.MuTargets,
       PortfolioOptimiser.CovMethods,
       PortfolioOptimiser.PosdefFixMethods,
       PortfolioOptimiser.DenoiseMethods,
       PortfolioOptimiser.RegCriteria,
       PortfolioOptimiser.FSMethods,
       PortfolioOptimiser.CorMethods,
...
for file in code_files
    Literate.markdown(example_path * file,
                      build_path;
