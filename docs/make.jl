...
makedocs(;
         ...
         pages = ["Home" => "index.md", "Examples" => examples_nav,
                  "API" => ["Solvers" => "Solvers.md",
                            "Risk" => ["Measures" => ["Util" => ["RiskMeasures/RiskMeasures1-1.md",
                                                                 "RiskMeasures/RiskMeasures1-2.md"],
                                                      "RiskMeasure" => ["RiskMeasures/RiskMeasures2-1.md",
                                                                        "RiskMeasures/RiskMeasures2-2.md",
                                                                        "RiskMeasures/RiskMeasures2-3.md",
                                                                        "RiskMeasures/RiskMeasures2-4.md",
                                                                        "RiskMeasures/RiskMeasures2-5.md",
                                                                        "RiskMeasures/RiskMeasures2-6.md"],
                                                      "HCRiskMeasure" => ["RiskMeasures/RiskMeasures3-1.md",
                                                                          "RiskMeasures/RiskMeasures3-2.md",
                                                                          "RiskMeasures/RiskMeasures3-3.md",
                                                                          "RiskMeasures/RiskMeasures3-4.md",
                                                                          "RiskMeasures/RiskMeasures3-5.md"],
                                                      "NoOptRiskMeasure" => ["RiskMeasures/RiskMeasures4-1.md"]],
                                       "RiskMeasures/RiskValue.md",
                            ...
                            "Constraints" => ["Constraints/WeightConstraints.md",
